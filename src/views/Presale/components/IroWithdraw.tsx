...
const StyledCard = styled(Card)`
  ...
  box-shadow: #fffaae 0px 0px 0px 1px, rgb(255 250 174 / 40%) 0px 0px 4px 8px;
    ...
    return (
        <StyledCard>
          ...
          <WrapperBody>
            ...
            <RowItem>
              <Text fontSize='16px'> Price per SCROOGE </Text>
              <StyledText fontSize='16px'> $0.5 </StyledText>
            </RowItem> 
            <RowItem>
            ...
            <RowItem>
              ...
              <StyledText fontSize='16px'> #12402825 </StyledText>
            </RowItem>
            <RowItem>
              <Text fontSize='16px'> Withdraw Starts </Text>
              <StyledText fontSize='16px'> NOV 1 20:00 </StyledText>
            </RowItem>
          <Spacer size='md' />
          <StyledBuyButton> Withdraw SCROOGE </StyledBuyButton>
          </WrapperBody>
        </StyledCard>
    )
